...
/**
 * This class is responsible from managing the data for TargetUsersPerspective
 *
 * Class TargetUsersPerspectiveService.
 *
...
class AbstractTargetUsersPerspectiveService
{
    public static function get(TargetUsersPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new TargetUsersPerspectiveQueryFilter($request);
        }
        ...
        $model = TargetUsersPerspective::filter($filter);
    ...
    {
        return TargetUsersPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?TargetUsersPerspective
    {
        return TargetUsersPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = TargetUsersPerspective::class;
    ...
    {
        $object = TargetUsersPerspective::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\CRM\TargetUsersPerspective')
            ->first();
     ...
     *
     * @param  $id
     * @return TargetUsersPerspective|null
     */
    public static function getById($id) : ?TargetUsersPerspective
    {
        return TargetUsersPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = TargetUsersPerspective::where('uuid', $uuid)->first();
     ...
     *
     * @param  array $data
     * @return TargetUsersPerspective
     */
    public static function updateRaw(array $data) : ?TargetUsersPerspective
    {
    ...
    {
        $model = TargetUsersPerspective::where('uuid', $id)->first();
