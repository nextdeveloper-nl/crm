 ...
 */
class AbstractIdealCustomerProfilesService
{
    public static function get(IdealCustomerProfilesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new IdealCustomerProfilesQueryFilter($request);
        }
        ...
        $model = IdealCustomerProfiles::filter($filter);
    ...
    {
        return IdealCustomerProfiles::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?IdealCustomerProfiles
    {
        return IdealCustomerProfiles::findByRef($ref);
    }

    public static function getActions()
    {
        $model = IdealCustomerProfiles::class;
     ...
     *
     * @param  $id
     * @return IdealCustomerProfiles|null
     */
    public static function getById($id) : ?IdealCustomerProfiles
    {
        return IdealCustomerProfiles::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = IdealCustomerProfiles::where('uuid', $uuid)->first();
     ...
     */
    public static function updateRaw(array $data) : ?IdealCustomerProfiles
    {
    ...
    {
        $model = IdealCustomerProfiles::where('uuid', $id)->first();
