 ...
 */
class AbstractQuoteItemsService
{
    public static function get(QuoteItemsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new QuoteItemsQueryFilter($request);
        }
        ...
        $model = QuoteItems::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?QuoteItems
    {
        return QuoteItems::findByRef($ref);
    }

    public static function getActions()
    {
        $model = QuoteItems::class;
    ...
    {
        $object = QuoteItems::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\CRM\QuoteItems')
            ->first();
     ...
     *
     * @param  $id
     * @return QuoteItems|null
     */
    public static function getById($id) : ?QuoteItems
    {
        return QuoteItems::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = QuoteItems::where('uuid', $uuid)->first();
     ...
     * @return QuoteItems
     */
    public static function updateRaw(array $data) : ?QuoteItems
    {
    ...
    {
        $model = QuoteItems::where('uuid', $id)->first();
