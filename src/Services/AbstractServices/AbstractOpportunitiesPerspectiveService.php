 ...
 */
class AbstractOpportunitiesPerspectiveService
{
    public static function get(OpportunitiesPerspectiveQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new OpportunitiesPerspectiveQueryFilter($request);
        }
        ...
        $model = OpportunitiesPerspective::filter($filter);
    ...
    {
        return OpportunitiesPerspective::all();
    }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?OpportunitiesPerspective
    {
        return OpportunitiesPerspective::findByRef($ref);
    }

    public static function getActions()
    {
        $model = OpportunitiesPerspective::class;
    ...
    {
        $object = OpportunitiesPerspective::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\CRM\OpportunitiesPerspective')
            ->first();
     ...
     *
     * @param  $id
     * @return OpportunitiesPerspective|null
     */
    public static function getById($id) : ?OpportunitiesPerspective
    {
        return OpportunitiesPerspective::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = OpportunitiesPerspective::where('uuid', $uuid)->first();
     ...
     *
     * @param  array $data
     * @return OpportunitiesPerspective
     */
    public static function updateRaw(array $data) : ?OpportunitiesPerspective
    {
    ...
    {
        $model = OpportunitiesPerspective::where('uuid', $id)->first();
