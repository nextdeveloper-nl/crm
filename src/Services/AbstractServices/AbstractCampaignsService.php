...
class AbstractCampaignsService
{
    public static function get(CampaignsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new CampaignsQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Campaigns
    {
        return Campaigns::findByRef($ref);
    }
    ...
    {
        $object = Campaigns::where('uuid', $objectId)->first();
     ...
     */
    public static function getById($id) : ?Campaigns
    {
    ...
    {
        try {
            $obj = Campaigns::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\CRM\Campaigns', $model);
     ...
     * @return Campaigns
     */
    public static function updateRaw(array $data) : ?Campaigns
    {
    ...
    {
        $model = Campaigns::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\CRM\Campaigns', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\CRM\Campaigns', $model);
