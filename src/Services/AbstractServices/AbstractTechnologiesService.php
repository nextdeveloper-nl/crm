...
/**
 * This class is responsible from managing the data for Technologies
 *
...
class AbstractTechnologiesService
{
    public static function get(TechnologiesQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new TechnologiesQueryFilter($request);
        }
        ...
        $model = Technologies::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Technologies
    {
        return Technologies::findByRef($ref);
    }

    public static function getActions()
    {
        $model = Technologies::class;
    ...
    {
        $object = Technologies::where('uuid', $objectId)->first();
     ...
     */
    public static function getById($id) : ?Technologies
    {
    ...
    {
        try {
            $obj = Technologies::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\CRM\Technologies', $model);
     ...
     * @return Technologies
     */
    public static function updateRaw(array $data) : ?Technologies
    {
    ...
    {
        $model = Technologies::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\CRM\Technologies', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\CRM\Technologies', $model);
