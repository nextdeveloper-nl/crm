...
/**
 * This class is responsible from managing the data for TargetUsers
 *
...
class AbstractTargetUsersService
{
    public static function get(TargetUsersQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new TargetUsersQueryFilter($request);
        }
        ...
        $model = TargetUsers::filter($filter);
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?TargetUsers
    {
        return TargetUsers::findByRef($ref);
    }

    public static function getActions()
    {
        $model = TargetUsers::class;
    ...
    {
        $object = TargetUsers::where('uuid', $objectId)->first();
     ...
     */
    public static function getById($id) : ?TargetUsers
    {
    ...
    {
        try {
            $obj = TargetUsers::where('uuid', $uuid)->first();
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\CRM\TargetUsers', $model);
     ...
     * @return TargetUsers
     */
    public static function updateRaw(array $data) : ?TargetUsers
    {
    ...
    {
        $model = TargetUsers::where('uuid', $id)->first();
        ...
        Events::fire('updated:NextDeveloper\CRM\TargetUsers', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\CRM\TargetUsers', $model);
