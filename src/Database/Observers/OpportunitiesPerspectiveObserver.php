...
/**
 * Class OpportunitiesPerspectiveObserver
 *
...
class OpportunitiesPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\OpportunitiesPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\OpportunitiesPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\OpportunitiesPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\OpportunitiesPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\OpportunitiesPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\OpportunitiesPerspective', $model);
    }
