...
class MeetingsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Meetings', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Meetings', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Meetings', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Meetings', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Meetings', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Meetings', $model);
    }
