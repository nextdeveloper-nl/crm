...
class AccountsPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\AccountsPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\AccountsPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\AccountsPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\AccountsPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\AccountsPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\AccountsPerspective', $model);
    }
