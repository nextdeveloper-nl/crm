...
class CallsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Calls', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Calls', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Calls', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Calls', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Calls', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Calls', $model);
    }
