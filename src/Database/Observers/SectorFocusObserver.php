...
class SectorFocusObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\SectorFocus', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\SectorFocus', $model);
    }
