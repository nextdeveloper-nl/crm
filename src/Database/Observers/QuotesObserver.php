...
class QuotesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Quotes', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Quotes', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Quotes', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Quotes', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Quotes', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Quotes', $model);
    }
