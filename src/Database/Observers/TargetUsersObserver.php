...
class TargetUsersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\TargetUsers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\TargetUsers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\TargetUsers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\TargetUsers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\TargetUsers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\TargetUsers', $model);
    }
