...
class AccountManagersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\AccountManagers', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\AccountManagers', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\AccountManagers', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\AccountManagers', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\AccountManagers', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\AccountManagers', $model);
    }
