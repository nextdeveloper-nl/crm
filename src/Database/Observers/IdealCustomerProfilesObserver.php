...
/**
 * Class IdealCustomerProfilesObserver
 *
...
class IdealCustomerProfilesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\IdealCustomerProfiles', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\IdealCustomerProfiles', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\IdealCustomerProfiles', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\IdealCustomerProfiles', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\IdealCustomerProfiles', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\IdealCustomerProfiles', $model);
    }
