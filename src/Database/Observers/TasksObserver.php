...
class TasksObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Tasks', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Tasks', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Tasks', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Tasks', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Tasks', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Tasks', $model);
    }
