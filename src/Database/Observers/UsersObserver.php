...
class UsersObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Users', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Users', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Users', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Users', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Users', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Users', $model);
    }
