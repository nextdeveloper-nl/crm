...
class ProjectsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Projects', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Projects', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Projects', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Projects', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Projects', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Projects', $model);
    }
