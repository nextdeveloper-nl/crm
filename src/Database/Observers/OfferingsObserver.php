...
class OfferingsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Offerings', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Offerings', $model);
    }
