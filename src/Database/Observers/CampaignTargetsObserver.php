...
class CampaignTargetsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\CampaignTargets', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\CampaignTargets', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\CampaignTargets', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\CampaignTargets', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\CampaignTargets', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\CampaignTargets', $model);
    }
