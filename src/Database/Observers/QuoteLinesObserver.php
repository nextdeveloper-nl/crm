...
class QuoteLinesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\QuoteLines', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\QuoteLines', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\QuoteLines', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\QuoteLines', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\QuoteLines', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\QuoteLines', $model);
    }
