...
class CampaignsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Campaigns', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Campaigns', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Campaigns', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Campaigns', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Campaigns', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Campaigns', $model);
    }
