...
class TechnologiesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Technologies', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Technologies', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Technologies', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Technologies', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Technologies', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Technologies', $model);
    }
