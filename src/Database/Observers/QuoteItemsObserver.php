...
class QuoteItemsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\QuoteItems', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\QuoteItems', $model);
    }
