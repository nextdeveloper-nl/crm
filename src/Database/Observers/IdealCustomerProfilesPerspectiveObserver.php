...
/**
 * Class IdealCustomerProfilesPerspectiveObserver
 *
...
class IdealCustomerProfilesPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\IdealCustomerProfilesPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\IdealCustomerProfilesPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\IdealCustomerProfilesPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\IdealCustomerProfilesPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\IdealCustomerProfilesPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\IdealCustomerProfilesPerspective', $model);
    }
