...
class TargetsObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Targets', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Targets', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Targets', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Targets', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Targets', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Targets', $model);
    }
