...
class OpportunitiesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Opportunities', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Opportunities', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Opportunities', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Opportunities', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Opportunities', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Opportunities', $model);
    }
