...
/**
 * Class UsersPerspectiveObserver
 *
...
class UsersPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\UsersPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\UsersPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\UsersPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\UsersPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\UsersPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\UsersPerspective', $model);
    }
