...
class NotesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Notes', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Notes', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Notes', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Notes', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Notes', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Notes', $model);
    }
