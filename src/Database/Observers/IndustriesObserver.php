...
class IndustriesObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\Industries', $model);
    }
    ...
    {
        Events::fire('created:NextDeveloper\CRM\Industries', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\Industries', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\Industries', $model);
    }
    ...
    public function updating(Model $model)
    {
        ...
        Events::fire('updating:NextDeveloper\CRM\Industries', $model);
    }
    ...
    {
        Events::fire('updated:NextDeveloper\CRM\Industries', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\Industries', $model);
    }
    ...
    {
        Events::fire('deleted:NextDeveloper\CRM\Industries', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\Industries', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\Industries', $model);
    }
