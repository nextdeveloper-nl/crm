...
class AccountUsersPerspectiveObserver
{
    ...
    public function creating(Model $model)
    {
        ...
        Events::fire('creating:NextDeveloper\CRM\AccountUsersPerspective', $model);
    }
    ...
    public function saving(Model $model)
    {
        ...
        Events::fire('saving:NextDeveloper\CRM\AccountUsersPerspective', $model);
    }
    ...
    {
        Events::fire('saved:NextDeveloper\CRM\AccountUsersPerspective', $model);
    }
    ...
    public function deleting(Model $model)
    {
        ...
        Events::fire('deleting:NextDeveloper\CRM\AccountUsersPerspective', $model);
    }
    ...
    public function restoring(Model $model)
    {
        ...
        Events::fire('restoring:NextDeveloper\CRM\AccountUsersPerspective', $model);
    }
    ...
    {
        Events::fire('restored:NextDeveloper\CRM\AccountUsersPerspective', $model);
    }
