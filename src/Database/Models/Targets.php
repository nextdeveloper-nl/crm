...
class Targets extends Model
{
    ...
    public function crmTargets() : \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(\NextDeveloper\Intelligence\Database\Models\CrmTargets::class);
    }
