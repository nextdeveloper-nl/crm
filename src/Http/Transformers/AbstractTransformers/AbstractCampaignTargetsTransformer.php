 ...
 */
class AbstractCampaignTargetsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(CampaignTargets $model)
    {
    ...
    public function includeActions(CampaignTargets $model)
    {
    ...
    public function includeMedia(CampaignTargets $model)
    {
    ...
    public function includeSocialMedia(CampaignTargets $model)
    {
    ...
    public function includeComments(CampaignTargets $model)
    {
    ...
    public function includeVotes(CampaignTargets $model)
    {
    ...
    public function includeMeta(CampaignTargets $model)
    {
    ...
    public function includePhoneNumbers(CampaignTargets $model)
    {
    ...
    public function includeAddresses(CampaignTargets $model)
    {
