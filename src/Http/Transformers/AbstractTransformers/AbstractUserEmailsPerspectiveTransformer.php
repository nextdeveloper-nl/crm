 ...
 */
class AbstractUserEmailsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(UserEmailsPerspective $model)
    {
    ...
    public function includeActions(UserEmailsPerspective $model)
    {
    ...
    public function includeMedia(UserEmailsPerspective $model)
    {
    ...
    public function includeSocialMedia(UserEmailsPerspective $model)
    {
    ...
    public function includeComments(UserEmailsPerspective $model)
    {
    ...
    public function includeVotes(UserEmailsPerspective $model)
    {
    ...
    public function includeMeta(UserEmailsPerspective $model)
    {
    ...
    public function includePhoneNumbers(UserEmailsPerspective $model)
    {
    ...
    public function includeAddresses(UserEmailsPerspective $model)
    {
