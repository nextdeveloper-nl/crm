...
class AbstractCallsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(Calls $model)
    {
    ...
    public function includeActions(Calls $model)
    {
    ...
    public function includeMedia(Calls $model)
    {
    ...
    public function includeSocialMedia(Calls $model)
    {
    ...
    public function includeComments(Calls $model)
    {
    ...
    public function includeVotes(Calls $model)
    {
    ...
    public function includeMeta(Calls $model)
    {
    ...
    public function includePhoneNumbers(Calls $model)
    {
    ...
    public function includeAddresses(Calls $model)
    {
