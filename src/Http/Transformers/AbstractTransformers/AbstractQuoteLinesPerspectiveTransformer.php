 ...
 */
class AbstractQuoteLinesPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(QuoteLinesPerspective $model)
    {
    ...
    public function includeActions(QuoteLinesPerspective $model)
    {
    ...
    public function includeMedia(QuoteLinesPerspective $model)
    {
    ...
    public function includeSocialMedia(QuoteLinesPerspective $model)
    {
    ...
    public function includeComments(QuoteLinesPerspective $model)
    {
    ...
    public function includeVotes(QuoteLinesPerspective $model)
    {
    ...
    public function includeMeta(QuoteLinesPerspective $model)
    {
    ...
    public function includePhoneNumbers(QuoteLinesPerspective $model)
    {
    ...
    public function includeAddresses(QuoteLinesPerspective $model)
    {
