 ...
 */
class AbstractCampaignTargetsPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(CampaignTargetsPerspective $model)
    {
    ...
    public function includeActions(CampaignTargetsPerspective $model)
    {
    ...
    public function includeMedia(CampaignTargetsPerspective $model)
    {
    ...
    public function includeSocialMedia(CampaignTargetsPerspective $model)
    {
    ...
    public function includeComments(CampaignTargetsPerspective $model)
    {
    ...
    public function includeVotes(CampaignTargetsPerspective $model)
    {
    ...
    public function includeMeta(CampaignTargetsPerspective $model)
    {
    ...
    public function includePhoneNumbers(CampaignTargetsPerspective $model)
    {
    ...
    public function includeAddresses(CampaignTargetsPerspective $model)
    {
