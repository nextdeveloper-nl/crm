 ...
 */
class AbstractCampaignTargetUsersPerspectiveTransformer extends AbstractTransformer
{
    ...
    public function includeStates(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includeActions(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includeMedia(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includeSocialMedia(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includeComments(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includeVotes(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includeMeta(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includePhoneNumbers(CampaignTargetUsersPerspective $model)
    {
    ...
    public function includeAddresses(CampaignTargetUsersPerspective $model)
    {
