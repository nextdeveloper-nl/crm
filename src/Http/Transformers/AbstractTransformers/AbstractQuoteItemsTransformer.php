 ...
 */
class AbstractQuoteItemsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(QuoteItems $model)
    {
    ...
    public function includeActions(QuoteItems $model)
    {
    ...
    public function includeMedia(QuoteItems $model)
    {
    ...
    public function includeSocialMedia(QuoteItems $model)
    {
    ...
    public function includeComments(QuoteItems $model)
    {
    ...
    public function includeVotes(QuoteItems $model)
    {
    ...
    public function includeMeta(QuoteItems $model)
    {
    ...
    public function includePhoneNumbers(QuoteItems $model)
    {
    ...
    public function includeAddresses(QuoteItems $model)
    {
