...
class AbstractUsersTransformer extends AbstractTransformer
{
    ...
    public function includeMedia(Users $model)
    {
    ...
    public function includeSocialMedia(Users $model)
    {
    ...
    public function includeComments(Users $model)
    {
    ...
    public function includeVotes(Users $model)
    {
    ...
    public function includeMeta(Users $model)
    {
    ...
    public function includePhoneNumbers(Users $model)
    {
    ...
    public function includeAddresses(Users $model)
    {
