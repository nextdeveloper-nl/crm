...
class AbstractUserManagersTransformer extends AbstractTransformer
{
    ...
    public function includeStates(UserManagers $model)
    {
    ...
    public function includeActions(UserManagers $model)
    {
    ...
    public function includeMedia(UserManagers $model)
    {
    ...
    public function includeSocialMedia(UserManagers $model)
    {
    ...
    public function includeComments(UserManagers $model)
    {
    ...
    public function includeVotes(UserManagers $model)
    {
    ...
    public function includeMeta(UserManagers $model)
    {
    ...
    public function includePhoneNumbers(UserManagers $model)
    {
    ...
    public function includeAddresses(UserManagers $model)
    {
