 ...
 */
class AbstractTargetUsersTransformer extends AbstractTransformer
{
    ...
    public function includeStates(TargetUsers $model)
    {
    ...
    public function includeActions(TargetUsers $model)
    {
    ...
    public function includeMedia(TargetUsers $model)
    {
    ...
    public function includeSocialMedia(TargetUsers $model)
    {
    ...
    public function includeComments(TargetUsers $model)
    {
    ...
    public function includeVotes(TargetUsers $model)
    {
    ...
    public function includeMeta(TargetUsers $model)
    {
    ...
    public function includePhoneNumbers(TargetUsers $model)
    {
    ...
    public function includeAddresses(TargetUsers $model)
    {
