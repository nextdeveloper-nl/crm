...
Route::prefix('crm')->group(
    function () {
        ...
        Route::prefix('account-managers-perspective')->group(
            function () {
                Route::get('/', 'AccountManagersPerspective\AccountManagersPerspectiveController@index');
                Route::get('/actions', 'AccountManagersPerspective\AccountManagersPerspectiveController@getActions');

                Route::get('{crm_account_managers_perspective}/tags ', 'AccountManagersPerspective\AccountManagersPerspectiveController@tags');
                Route::post('{crm_account_managers_perspective}/tags ', 'AccountManagersPerspective\AccountManagersPerspectiveController@saveTags');
                Route::get('{crm_account_managers_perspective}/addresses ', 'AccountManagersPerspective\AccountManagersPerspectiveController@addresses');
                Route::post('{crm_account_managers_perspective}/addresses ', 'AccountManagersPerspective\AccountManagersPerspectiveController@saveAddresses');

                Route::get('/{crm_account_managers_perspective}/{subObjects}', 'AccountManagersPerspective\AccountManagersPerspectiveController@relatedObjects');
                Route::get('/{crm_account_managers_perspective}', 'AccountManagersPerspective\AccountManagersPerspectiveController@show');

                Route::post('/', 'AccountManagersPerspective\AccountManagersPerspectiveController@store');
                Route::post('/{crm_account_managers_perspective}/do/{action}', 'AccountManagersPerspective\AccountManagersPerspectiveController@doAction');

                Route::patch('/{crm_account_managers_perspective}', 'AccountManagersPerspective\AccountManagersPerspectiveController@update');
                Route::delete('/{crm_account_managers_perspective}', 'AccountManagersPerspective\AccountManagersPerspectiveController@destroy');
            }
        );
        ...
        Route::prefix('monthly-new-accounts-per-dist-performance')->group(
            function () {
                ...
                Route::get('/actions', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@getActions');

                Route::get('{cmnapdp}/tags ', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@tags');
                Route::post('{cmnapdp}/tags ', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@saveTags');
                Route::get('{cmnapdp}/addresses ', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@addresses');
                Route::post('{cmnapdp}/addresses ', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@saveAddresses');

                Route::get('/{cmnapdp}/{subObjects}', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@relatedObjects');
                Route::get('/{cmnapdp}', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@show');

                Route::post('/', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@store');
                Route::post('/{cmnapdp}/do/{action}', 'MonthlyNewAccountsPerDistPerformance\MonthlyNewAccountsPerDistPerformanceController@doAction');
